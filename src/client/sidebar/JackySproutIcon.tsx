export function JackySproutIcon({ size = 16 }: { size?: number }) {
  return (
    <svg
      ...
      focusable="false"
    >
      <path d="M11.5 20.5v-7.3" stroke="#111111" strokeWidth="1.8" strokeLinecap="round" />
      <path
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M6.35 9.2c1.64.25 2.83.9 3.61 1.95" stroke="#D9F57C" strokeWidth="0.9" strokeLinecap="round" />
      <path d="M15 7.04c1.08-.74 2.06-1.06 3.08-1.1" stroke="#D9F57C" strokeWidth="0.9" strokeLinecap="round" />
    </svg>
  );
}
